...
World::World(const Level &level)
    : tilemap{level.width, level.height}, backgrounds{level.backgrounds}, animated_background{level.animated_background}, load_level_tile{tilemap(level.load_level_position.x, level.load_level_position.y)}, level_number{level.level_number}, quadtree{AABB{{level.width / 2.0, level.height / 2.0}, {level.width / 2.0, level.height / 2.0}}}
{
